...
function InvoicePrint({ res, client, room, settings, cur }) {
  ...
  const handle = () => {
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;border-bottom:3px solid #c9a84c;padding-bottom:20px;margin-bottom:30px">
      <div>${settings.logoUrl?`<img src="${settings.logoUrl}" style="height:60px;object-fit:contain;margin-bottom:8px;display:block"/>`:`<div style="font-size:36px">🏨</div>`}<h1>FACTURE</h1><div style="font-size:18px;color:#555">${settings.hotelName}</div></div>
