      ...
      <div style={{maxWidth:1000,width:"100%"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:24,marginBottom:60}}>
          ...
          <div className="plan-card" style={{background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:24,padding:36,transition:"all 0.3s"}}>
            ...
            <a href="/register" style={{display:"block",background:"rgba(255,255,255,0.1)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:12,padding:"14px",color:"#fff",fontWeight:600,fontSize:15,textAlign:"center",textDecoration:"none",transition:"all 0.2s"}}>
              Start Free Trial →
            </a>
          </div>
          ...
          <div className="plan-card" style={{background:"linear-gradient(135deg,#c9a84c,#a8832a)",border:"none",borderRadius:24,padding:36,transition:"all 0.3s",position:"relative",overflow:"hidden",boxShadow:"0 8px 40px rgba(201,168,76,0.3)"}}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:32}}>
              {["✅ Everything in Free","✅ Unlimited rooms","✅ Custom domain","✅ Priority support","✅ Advanced analytics","✅ iCal sync Booking.com","✅ Online check-in"].map(f=>(
          ...
          <div className="plan-card" style={{background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.1)",borderRadius:24,padding:36,transition:"all 0.3s"}}>
            ...
            <a href="https://wa.me/212600000000?text=HotelPro Enterprise" style={{display:"block",background:"rgba(255,255,255,0.1)",border:"1px solid rgba(255,255,255,0.2)",borderRadius:12,padding:"14px",color:"#fff",fontWeight:600,fontSize:15,textAlign:"center",textDecoration:"none",transition:"all 0.2s"}}>
              Contact Us →
            </a>
          </div>
        </div>
